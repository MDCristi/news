<?php
	...
	function generate_article_form(){
		return $retval = '<form method="post" enctype="multipart/form-data">
							...
							<input type="text" name="article_name" class="article_name" id="article_name"/><br/>
							...
							<input tyle="text" name="article_city" class="article_city" id="article_city"><br/>
	...
	function generate_dropdown_with_regions($option = ''){
		...
		$retval = '<select name="article_region" class="article_region" id="article_region">';
	...
	function generate_comment_form(){
		return $retval = '<form method="post">
							<textarea name="comment" class="article_coment"  rows="4" cols="35" wrap="virtual">ai la dispozitie 700 de caracatere... </textarea><br/>
	...
	function change_user_data_form($username, $password, $city, $region, $sex, $email, $avatar, $age){
		 return ' <div id="user_data">
					...
					<form method="post">
						...
						<tr><td><p class="user_data">Age:   <input type="text" name="age" class="age" value="'.$age.'"/></p></td></tr>
						<tr><td><p class="user_data">Sex:   '.generate_dropdown_with_sex().'</p></td></tr>
						<tr><td><p class="user_data">Email:   <input type="text" name="email" class="email" value="'.$email.'"/></p></td></tr>
						<tr><td><p class="user_data"><input type="submit" name="submit" value="actualizeaza informatii"></td></tr>
					</form>
					</table><br/>
	...
	function generate_search_form(){
		return '<form method="post" class="search_engine">
					<input type="text" name="search_engine_input" size="38"/>
					<input type="submit" name="search_engine_submit" value="cauta"/>
				</form>
				';
	}
